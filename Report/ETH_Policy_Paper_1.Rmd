...
source(file.path(root, "Code/ETH_tab_pp.R"))
...
```{r Fig_1, dpi = 300, fig.width=15, fig.height=8}
Fig_maize_yield
```
...
```{r Fig-3, fig.width=10, fig.height=10}
Map_GYGA_PY
```

__Figure 3: Maize yield gap in Ethiopia__

```{r Fig-2, fig.width=10, fig.height=10}
Map_GYGA_YG
```
...
```{r Fig-4, fig.width=10, fig.height=5}
Fig_ss_a
```
