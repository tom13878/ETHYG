...
# Replace relative maize/fertilizer price by IFPRI value of 0.3 = 3.33 fertilizer/maize
# Id we assume equal proportion of DAP and UREA (0.46 and 0.18 N content), we divide by 0.33 gives a factor 10.1
db1$relprice <- 10.1
...
# mean water limited yield (Yw) is a reasonable proxy for
# missing information. 
